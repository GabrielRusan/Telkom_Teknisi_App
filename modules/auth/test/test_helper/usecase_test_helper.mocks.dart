...
// in auth/test/test_helper/usecase_test_helper.dart.
...
///
/// See the documentation for Mockito's code generation for more information.
class MockGetUserData extends _i1.Mock implements _i7.GetUserData {
  MockGetUserData() {
    _i1.throwOnMissingStub(this);
  }
  ...
  @override
  _i5.Future<_i3.Either<_i6.Failure, _i8.User>> execute() =>
      (super.noSuchMethod(
        Invocation.method(
          #execute,
          [],
